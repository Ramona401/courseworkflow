...
// v123 新增:/api/v1/lesson-plans/plans/{id}/assets — 教案图片资产管理
//          /api/v1/lesson-plans/assets/{asset_id} — 资产详情/更新/删除
// 迭代3.5 A2-2 新增:PUT /api/v1/lesson-plans/plans/{id}/textbooks — 课本中途挂载
...
// 参考资料附件(PDF/Word) 新增:
//   POST    /api/v1/lesson-plans/ref-material/compress — 长参考资料 AI 压缩为结构化要点
//          （老师上传 PDF/Word 后前端提取文字，长文档调此端点压缩；短文档直接注入不调此。
...
//
// v123 改动:新增 assetHandler 参数(教案图片资产处理器)
