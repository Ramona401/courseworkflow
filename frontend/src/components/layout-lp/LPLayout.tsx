  ...
  return (
    <div ref={menuRef} style={{ position: 'relative' }}>
      ...
      >
        ...
        <span style={{ fontSize: '13px', fontWeight: 500, color: '#1F2937', maxWidth: '80px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          {user?.display_name}
        </span>
  ...
  return (
    <button
      ...
      style={{
        ...
        background: hovered
          ? (danger ? 'rgba(239,68,68,0.06)' : highlight ? 'rgba(79,123,232,0.08)' : '#F9FAFB')
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#FAFBFC' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <header style={{
          ...
          <h2 style={{ flex: 1, fontSize: '20px', fontWeight: 600, color: '#1F2937', margin: 0, letterSpacing: '-0.3px' }}>
            {pageTitle}
          </h2>
          <UserMenu />
        </header>
